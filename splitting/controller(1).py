...
class SubtitleController:
    ...
    def _update_episode_nav_controls(self) -> None:
        return self.episode_controller._update_episode_nav_controls()

    @staticmethod
    def _normalize_anime_key(value) -> str:
        return self.episode_controller._normalize_anime_key()

    def _restore_startup_time_and_mode(self) -> None:
        return self.episode_controller._restore_startup_time_and_mode()
    ...
    def _on_copy_popup(self, event=None):
        return self.clipboard._on_copy_popup(event)

    @staticmethod
    def _segments_to_copy_text(top_segments, bottom_segments) -> str:
        return self.clipboard._segments_to_copy_text(bottom_segments)
    ...
    def _format_delta_seconds(value: float) -> str:
        return self.subtitle_navigation._format_delta_seconds()
    ...
    def _reset_canvas(self):
        return self.subtitle_navigation._reset_canvas()

    def _hide_subtitles_temporarily(self):
        return self.subtitle_navigation._hide_subtitles_temporarily()
    ...
    def _on_open_srt(self, event=None):
        return self.episode_controller._on_open_srt(event)
    ...
    def simulate_video_click(self, above_window=None):
        return self.mouse_controller.simulate_video_click(above_window)

    def _on_global_click(self, x, y, button, pressed):
        return self.mouse_controller._on_global_click(x, y, button, pressed)
    ...
    def _seek_step_action_name(action: str) -> str | None:
        return self.hotkey_controller._seek_step_action_name()

    def _queue_names_for_repeat_action(self, action: str, settle_seek: bool=True) -> set[str]:
        return self.hotkey_controller._queue_names_for_repeat_action(action, settle_seek)
    ...
    def _release_repeat_actions(self, actions: set[str], settle_seek: bool=True) -> None:
        return self.hotkey_controller._release_repeat_actions(actions, settle_seek)
    ...
    def _is_numpad_vk_key(key, *codes: int) -> bool:
        return self.hotkey_controller._is_numpad_vk_key(*codes)
    ...
    def _normalize_shortcut_token(token: str) -> str:
        return self.hotkey_controller._normalize_shortcut_token()
    ...
    def _is_text_input_widget(widget) -> bool:
        return self.hotkey_controller._is_text_input_widget()
    ...
    def _rects_intersect(a, b) -> bool:
        return self.ocr_controller._rects_intersect(b)

    @staticmethod
    def _window_screen_rect(win):
        return self.ocr_controller._window_screen_rect()
    ...
    def _ocr_auto_enabled(self) -> bool:
        return self.ocr_controller._ocr_auto_enabled()

    @staticmethod
    def _coerce_bool(value, default: bool=False) -> bool:
        return self.ocr_controller._coerce_bool(default)

    @staticmethod
    def _coerce_int(value, default: int=0) -> int:
        return self.ocr_controller._coerce_int(default)

    @staticmethod
    def _coerce_float(value, default: float=0.0) -> float:
        return self.ocr_controller._coerce_float(default)
    ...
    def _resolve_ocr_screen_rect(monitors, screen_idx: int):
        return self.ocr_controller._resolve_ocr_screen_rect(screen_idx)
